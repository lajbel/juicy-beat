(() => {
    ...
    var require_regex = __commonJS({
        "node_modules/tja/dist/common/regex.js"(exports) {
            ...
            exports.NOTE_REGEX =
                exports.AUTHOR_REGEX =
                exports.LINE_REGEX =
                exports.PIPE_REGEX =
                exports.ESCAPED_COMMA_REGEX =
                exports.SPACE_REGEX =
                    void 0;
    ...
    var require_MetadataProperty = __commonJS({
        "node_modules/tja/dist/models/common/MetadataProperty.js"(exports) {
            "use strict";
            Object.defineProperty(exports, "__esModule", { value: true });
            exports.CourseMetadataProperty =
                exports.SongMetadataProperty =
                    void 0;
            ...
            (function(SongMetadataProperty2) {
                ...
                SongMetadataProperty = exports.SongMetadataProperty
                    || (exports.SongMetadataProperty = {}),
            );
            ...
            (function(CourseMetadataProperty2) {
                ...
                CourseMetadataProperty = exports.CourseMetadataProperty
                    || (exports.CourseMetadataProperty = {}),
            );
        },
    });
            ...
            var Style = class _Style {
                ...
                static fromRaw(raw, strict = true) {
                    ...
                    return isNaN(parsedValue)
                        ? _Style.fromName(raw, strict)
                        : _Style.fromId(parsedValue, strict);
                }
                toString() {
                    return this._name;
                }
            ...
            var CourseVariant = class {
                ...
                toString() {
                    const builder = new StringBuilder_1.StringBuilder()
                        .withSeparator("\n").append(
                            `${MetadataProperty_1.CourseMetadataProperty.Style}:${this.style}`,
                        ).append(
                            `${MetadataProperty_1.CourseMetadataProperty.ScoreInit}:${this.scoreInit}`,
                        ).append(
                            `${MetadataProperty_1.CourseMetadataProperty.ScoreDiff}:${this.scoreDiff}`,
                        );
                    if (this.balloonCounts.length > 0) {
                        builder.append(
                            `${MetadataProperty_1.CourseMetadataProperty.Balloon}:${
                                this.balloonCounts.join(",")
                            }`,
                        );
                    }
                    if (
                        this.branchBalloonCounts[BranchType_1.BranchType.Normal]
                            .length > 0
                    ) {
                        builder.append(
                            `${MetadataProperty_1.CourseMetadataProperty.BalloonNor}:${
                                this.branchBalloonCounts[
                                    BranchType_1.BranchType.Normal
                                ].join(",")
                            }`,
                    ...
                    if (
                        ...
                        builder.append(
                            `${MetadataProperty_1.CourseMetadataProperty.BalloonExp}:${
                                this.branchBalloonCounts[
                                    BranchType_1.BranchType.Advanced
                                ].join(",")
                            }`,
                    ...
                    if (
                        this.branchBalloonCounts[BranchType_1.BranchType.Master]
                            .length > 0
                    ) {
                        builder.append(
                            `${MetadataProperty_1.CourseMetadataProperty.BalloonMas}:${
                                this.branchBalloonCounts[
                                    BranchType_1.BranchType.Advanced
                                ].join(",")
                            }`,
                    ...
                    if (this.hiddenBranches) {
                        builder.append(
                            `${MetadataProperty_1.CourseMetadataProperty.HiddenBranch}:1`,
                        );
                    }
                    if (this.gauges[0]) {
                        builder.append(
                            `${MetadataProperty_1.CourseMetadataProperty.Exam1}:${
                                this.gauges[0].toString()
                            }`,
                        );
                    }
                    if (this.gauges[1]) {
                    ...
                    if (this.gauges[2]) {
                        builder.append(
                            `${MetadataProperty_1.CourseMetadataProperty.Exam3}:${
                                this.gauges[2].toString()
                            }`,
                        );
                    }
                    if (this.gaugeIncrementMethod) {
                        builder.append(
                            `${MetadataProperty_1.CourseMetadataProperty.GaugeIncr}:${this.gaugeIncrementMethod}`,
                        );
                    }
                    if (this.gaugeTotal) {
                        builder.append(
                            `${MetadataProperty_1.CourseMetadataProperty.Total}:${this.gaugeTotal}`,
                        );
                    }
                    builder.append("\n");
                 ...
                 */
                isEmpty() {
                    return this._singleCommands.length === 0
                ...
                postProcessCommand(command) {
                    if (
                        command.commandType
                            === CommandType_1.CommandType.BranchStart
                    ) {
                    ...
                    if (
                        command.commandType
                            === CommandType_1.CommandType.BranchMarker
                    ) {
                    ...
                    if (
                        command.commandType
                            === CommandType_1.CommandType.NoteSequence
                    ) {
                ...
                postProcessNote(note) {
                    if (
                        note.noteType === NoteType_1.NoteType.Balloon
                        || note.noteType === NoteType_1.NoteType.Kusudama
                    ) {
                        return this.postProcessBalloonNote(note);
                    }
                    if (
                        note.noteType === NoteType_1.NoteType.Drumroll
                        || note.noteType === NoteType_1.NoteType.DRUMROLL
                    ) {
                ...
                postProcessBalloonNote(note) {
                    ...
                    if (this._currentBranchType) {
                        counts =
                            this.branchBalloonCounts[this._currentBranchType];
                    }
                    note.count = this.getBalloonCount(
                        counts,
                        this._currentBalloonNoteIndex,
                    );
                }
    ...
    var require_Difficulty = __commonJS({
        "node_modules/tja/dist/models/course/lib/Difficulty.js"(exports) {
            ...
            var Difficulty = class _Difficulty {
                ...
                static fromId(id, strict = true) {
                    const difficulty = _Difficulty._values.find((d) =>
                        d._id === id
                    );
                    if (difficulty) {
                        return difficulty;
                ...
                static fromName(name, strict = true) {
                    const difficulty = _Difficulty._values.find((d) =>
                        d._name.toLowerCase() === name.toLowerCase()
                    );
                    if (difficulty) {
                        return difficulty;
                    }
                ...
                static fromRaw(raw, strict = true) {
                    const parsedValue = parseInt(raw, 10);
                    return isNaN(parsedValue)
                        ? _Difficulty.fromName(raw, strict)
                        : _Difficulty.fromId(parsedValue, strict);
                }
                toString() {
                    return this._name;
                }
    ...
    var require_Course = __commonJS({
        "node_modules/tja/dist/models/course/Course.js"(exports) {
            ...
            var Course = class {
                 ...
                 */
                get activeCourse() {
                    return this._activeCourseStyle === Style_1.Style.Single
                        ? this.singleCourse
                        : this.doubleCourse;
                }
                /**
                ...
                addCommand(command) {
                    if (
                        command.commandType === CommandType_1.CommandType.Start
                    ) {
                ...
                toString() {
                    const builder = new StringBuilder_1.StringBuilder()
                        .withSeparator("\n").append(
                            `${MetadataProperty_1.CourseMetadataProperty.Course}:${this.difficulty}`,
                        ).append(
                            `${MetadataProperty_1.CourseMetadataProperty.Level}:${this.stars}`,
                        ).append("\n");
    ...
    var require_Game = __commonJS({
        "node_modules/tja/dist/models/song/lib/Game.js"(exports) {
            ...
            var Game = class _Game {
                ...
                static fromName(name, strict = true) {
                    const item = _Game._values.find((it2) =>
                        it2._name === name
                    );
                    if (item) {
                        return item;
    ...
    var require_ScoreMode = __commonJS({
        "node_modules/tja/dist/models/song/lib/ScoreMode.js"(exports) {
            ...
            var ScoreMode = class _ScoreMode {
                ...
                static fromId(id, strict = true) {
                    const item = _ScoreMode._values.find((it2) =>
                        it2._id === id
                    );
                    if (item) {
                        return item;
        ...
        "node_modules/tja/dist/models/song/Song.js"(exports) {
            ...
            var Song = class {
                ...
                toString() {
                    const builder = new StringBuilder_1.StringBuilder()
                        .withSeparator("\n").append(
                            `${MetadataProperty_1.SongMetadataProperty.Title}:${this.title}`,
                        );
                    if (this.localizedTitle.ja) {
                        builder.append(
                            `${MetadataProperty_1.SongMetadataProperty.TitleJA}:${this.localizedTitle.ja}`,
                        );
                    }
                    if (this.localizedTitle.en) {
                        builder.append(
                            `${MetadataProperty_1.SongMetadataProperty.TitleEN}:${this.localizedTitle.en}`,
                        );
                    }
                    if (this.localizedTitle.cn) {
                        builder.append(
                            `${MetadataProperty_1.SongMetadataProperty.TitleCN}:${this.localizedTitle.cn}`,
                        );
                    }
                    if (this.localizedTitle.tw) {
                        builder.append(
                            `${MetadataProperty_1.SongMetadataProperty.TitleTW}:${this.localizedTitle.tw}`,
                        );
                    }
                    if (this.localizedTitle.ko) {
                        builder.append(
                            `${MetadataProperty_1.SongMetadataProperty.TitleKO}:${this.localizedTitle.ko}`,
                        );
                    }
                    if (this.subtitle) {
                        builder.append(
                            `${MetadataProperty_1.SongMetadataProperty.Subtitle}:${this.subtitle}`,
                        );
                    }
                    if (this.localizedSubtitle.ja) {
                        builder.append(
                            `${MetadataProperty_1.SongMetadataProperty.SubtitleJA}:${this.localizedSubtitle.ja}`,
                        );
                    }
                    if (this.localizedSubtitle.en) {
                        builder.append(
                            `${MetadataProperty_1.SongMetadataProperty.SubtitleEN}:${this.localizedSubtitle.en}`,
                        );
                    }
                    if (this.localizedSubtitle.cn) {
                        builder.append(
                            `${MetadataProperty_1.SongMetadataProperty.SubtitleCN}:${this.localizedSubtitle.cn}`,
                        );
                    }
                    if (this.localizedSubtitle.tw) {
                        builder.append(
                            `${MetadataProperty_1.SongMetadataProperty.SubtitleTW}:${this.localizedSubtitle.tw}`,
                        );
                    }
                    if (this.localizedSubtitle.ko) {
                        builder.append(
                            `${MetadataProperty_1.SongMetadataProperty.SubtitleKO}:${this.localizedSubtitle.ko}`,
                        );
                    }
                    builder.append(
                        `${MetadataProperty_1.SongMetadataProperty.BPM}:${this.bpm}`,
                    );
                    if (this.wave) {
                        builder.append(
                            `${MetadataProperty_1.SongMetadataProperty.Wave}:${this.wave}`,
                        );
                    }
                    builder.append(
                        `${MetadataProperty_1.SongMetadataProperty.Offset}:${this.offset}`,
                    ).append(
                        `${MetadataProperty_1.SongMetadataProperty.DemoStart}:${this.demoStart}`,
                    );
                    if (this.genre) {
                        builder.append(
                            `${MetadataProperty_1.SongMetadataProperty.Genre}:${this.genre}`,
                        );
                    }
                    builder.append(
                        `${MetadataProperty_1.SongMetadataProperty.ScoreMode}:${this.scoreMode}`,
                    );
                    if (this.maker) {
                        if (this.maker.url) {
                            builder.append(
                                `${MetadataProperty_1.SongMetadataProperty.Maker}:${this.maker.name} <${this.maker.url}>`,
                            );
                        } else {
                            builder.append(
                                `${MetadataProperty_1.SongMetadataProperty.Maker}:${this.maker.name}`,
                            );
                        }
                    }
                    if (this.lyricsFilePath) {
                        builder.append(
                            `${MetadataProperty_1.SongMetadataProperty.Lyrics}:${this.lyricsFilePath}`,
                        );
                    }
                    builder.append(
                        `${MetadataProperty_1.SongMetadataProperty.SongVol}:${this.songVolume}`,
                    ).append(
                        `${MetadataProperty_1.SongMetadataProperty.SEVol}:${this.soundEffectVolume}`,
                    ).append(
                        `${MetadataProperty_1.SongMetadataProperty.Side}:${this.side}`,
                    ).append(
                        `${MetadataProperty_1.SongMetadataProperty.Life}:${this.life}`,
                    ).append(
                        `${MetadataProperty_1.SongMetadataProperty.Game}:${this.game}`,
                    );
                    if (this.headScroll) {
                        builder.append(
                            `${MetadataProperty_1.SongMetadataProperty.HeadScroll}:${this.headScroll}`,
                        );
                    }
                    if (this.backgroundImagePath) {
                        builder.append(
                            `${MetadataProperty_1.SongMetadataProperty.BGImage}:${this.backgroundImagePath}`,
                        );
                    }
                    if (this.backgroundMoviePath) {
                        builder.append(
                            `${MetadataProperty_1.SongMetadataProperty.BGMovie}:${this.backgroundMoviePath}`,
                        );
                    }
                    if (this.movieOffset) {
                        builder.append(
                            `${MetadataProperty_1.SongMetadataProperty.MovieOffset}:${this.movieOffset}`,
                        );
                    }
                    builder.append("\n");
    ...
    var require_MeasureCommand = __commonJS({
        "node_modules/tja/dist/models/command/types/MeasureCommand.js"(
            ...
            var Command_1 = require_Command();
            var CommandType_1 = require_CommandType();
            var MeasureCommand = class _MeasureCommand
                extends Command_1.Command
            {
                constructor(value) {
                ...
                static parse(args) {
                    ...
                    const value = args[0].split("/").map((v2) =>
                        parseInt(v2.trim(), 10)
                    ).filter((v2) => !isNaN(v2));
                    if (value.length !== 2) {
                        return void 0;
                    }
                    const measureValue = new MeasureValue_1.MeasureValue(
                        value[0],
                        value[1],
                    );
    ...
    var require_BPMChangeCommand = __commonJS({
        "node_modules/tja/dist/models/command/types/BPMChangeCommand.js"(
            ...
            var Command_1 = require_Command();
            var CommandType_1 = require_CommandType();
            var BPMChangeCommand = class _BPMChangeCommand
                extends Command_1.Command
            {
                constructor(value) {
    ...
    var require_GoGoStartCommand = __commonJS({
        "node_modules/tja/dist/models/command/types/GoGoStartCommand.js"(
            ...
            var Command_1 = require_Command();
            var CommandType_1 = require_CommandType();
            var GoGoStartCommand = class _GoGoStartCommand
                extends Command_1.Command
            {
                constructor() {
    ...
    var require_GoGoEndCommand = __commonJS({
        "node_modules/tja/dist/models/command/types/GoGoEndCommand.js"(
            ...
            var Command_1 = require_Command();
            var CommandType_1 = require_CommandType();
            var GoGoEndCommand = class _GoGoEndCommand
                extends Command_1.Command
            {
                constructor() {
    ...
    var require_BarLineOffCommand = __commonJS({
        "node_modules/tja/dist/models/command/types/BarLineOffCommand.js"(
            ...
            var Command_1 = require_Command();
            var CommandType_1 = require_CommandType();
            var BarLineOffCommand = class _BarLineOffCommand
                extends Command_1.Command
            {
                constructor() {
    ...
    var require_BarLineOnCommand = __commonJS({
        "node_modules/tja/dist/models/command/types/BarLineOnCommand.js"(
            ...
            var Command_1 = require_Command();
            var CommandType_1 = require_CommandType();
            var BarLineOnCommand = class _BarLineOnCommand
                extends Command_1.Command
            {
                constructor() {
    ...
    var require_BranchStartCommand = __commonJS({
        "node_modules/tja/dist/models/command/types/BranchStartCommand.js"(
            ...
            var CommandType_1 = require_CommandType();
            var BranchStartCommand = class _BranchStartCommand
                extends Command_1.Command
            {
                constructor(
                    requirementType,
                ...
                static parse(args, strict) {
                    ...
                    const requirementType = BranchRequirementType_1
                        .BranchRequirementType.fromRaw(components[0], strict);
                    if (!requirementType) {
                        return void 0;
                    }
                    ...
                    return new _BranchStartCommand(
                        requirementType,
                        advancedRequirement,
                        masterRequirement,
                    );
    ...
    var require_BranchEndCommand = __commonJS({
        "node_modules/tja/dist/models/command/types/BranchEndCommand.js"(
            ...
            var Command_1 = require_Command();
            var CommandType_1 = require_CommandType();
            var BranchEndCommand = class _BranchEndCommand
                extends Command_1.Command
            {
                constructor() {
    ...
    var require_SectionCommand = __commonJS({
        "node_modules/tja/dist/models/command/types/SectionCommand.js"(
            ...
            var Command_1 = require_Command();
            var CommandType_1 = require_CommandType();
            var SectionCommand = class _SectionCommand
                extends Command_1.Command
            {
                constructor() {
    ...
    var require_LevelHoldCommand = __commonJS({
        "node_modules/tja/dist/models/command/types/LevelHoldCommand.js"(
            ...
            var Command_1 = require_Command();
            var CommandType_1 = require_CommandType();
            var LevelHoldCommand = class _LevelHoldCommand
                extends Command_1.Command
            {
                constructor() {
    ...
    var require_BMScrollCommand = __commonJS({
        "node_modules/tja/dist/models/command/types/BMScrollCommand.js"(
            ...
            var Command_1 = require_Command();
            var CommandType_1 = require_CommandType();
            var BMScrollCommand = class _BMScrollCommand
                extends Command_1.Command
            {
                constructor() {
    ...
    var require_HBScrollCommand = __commonJS({
        "node_modules/tja/dist/models/command/types/HBScrollCommand.js"(
            ...
            var Command_1 = require_Command();
            var CommandType_1 = require_CommandType();
            var HBScrollCommand = class _HBScrollCommand
                extends Command_1.Command
            {
                constructor() {
    ...
    var require_NextSongCommand = __commonJS({
        "node_modules/tja/dist/models/command/types/NextSongCommand.js"(
            ...
            var Command_1 = require_Command();
            var CommandType_1 = require_CommandType();
            var NextSongCommand = class _NextSongCommand
                extends Command_1.Command
            {
                constructor(song) {
                    super(CommandType_1.CommandType.BMScroll);
                ...
                static parse(args) {
                    ...
                    const components = args[0].replace(
                        regex_1.ESCAPED_COMMA_REGEX,
                        "|",
                    ).split(",").map((c) => c.replace(regex_1.PIPE_REGEX, ","));
                    ...
                    course.activeCourse.scoreInit = parseInt(
                        components[4],
                        10,
                    );
                    course.activeCourse.scoreDiff = parseInt(
                        components[5],
                        10,
                    );
    ...
    var require_ScrollDirection = __commonJS({
        "node_modules/tja/dist/models/common/ScrollDirection.js"(exports) {
            ...
            var ScrollDirection = class _ScrollDirection {
                ...
                static fromId(id, strict = true) {
                    const item = _ScrollDirection._values.find((it2) =>
                        it2._id === id
                    );
                    if (item) {
                        return item;
    ...
    var require_DirectionCommand = __commonJS({
        "node_modules/tja/dist/models/command/types/DirectionCommand.js"(
            ...
            var Command_1 = require_Command();
            var CommandType_1 = require_CommandType();
            var DirectionCommand = class _DirectionCommand
                extends Command_1.Command
            {
                ...
                static parse(args, strict) {
                    ...
                    const direction = ScrollDirection_1.ScrollDirection.fromRaw(
                        args[0],
                        strict,
                    );
                    if (!direction) {
    ...
    var require_JPosScrollDirection = __commonJS({
        "node_modules/tja/dist/models/common/JPosScrollDirection.js"(exports) {
            ...
            var JPosScrollDirection = class _JPosScrollDirection {
                ...
                static fromId(id, strict = true) {
                    const item = _JPosScrollDirection._values.find((it2) =>
                        it2._id === id
                    );
                    if (item) {
                        return item;
                    ...
                    if (strict) {
                        throw new Error(
                            `Invalid JPosScrollDirection id: ${id}`,
                        );
                    }
                }
                static fromRaw(raw, strict = true) {
    ...
    var require_JPosScrollCommand = __commonJS({
        "node_modules/tja/dist/models/command/types/JPosScrollCommand.js"(
            ...
            var Command_1 = require_Command();
            var CommandType_1 = require_CommandType();
            var JPosScrollCommand = class _JPosScrollCommand
                extends Command_1.Command
            {
                ...
                static parse(args) {
                    ...
                    const direction = JPosScrollDirection_1.JPosScrollDirection
                        .fromRaw(args[2]);
                    if (!direction) {
                        return void 0;
                    }
    ...
    var require_BranchMarkerCommand = __commonJS({
        "node_modules/tja/dist/models/command/types/BranchMarkerCommand.js"(
            ...
            "use strict";
            Object.defineProperty(exports, "__esModule", { value: true });
            exports.MasterBranchMarkerCommand =
                exports.AdvancedBranchMarkerCommand =
                exports.NormalBranchMarkerCommand =
                exports.BranchMarkerCommand =
                    void 0;
            var Command_1 = require_Command();
            var BranchType_1 = require_BranchType();
            var CommandType_1 = require_CommandType();
            ...
            var AdvancedBranchMarkerCommand = class
                extends BranchMarkerCommand
            {
                constructor() {
    ...
    var require_Balloon = __commonJS({
        "node_modules/tja/dist/models/note/types/Balloon.js"(exports) {
            ...
            var Balloon = class
                extends CountableDrumrollNote_1.CountableDrumrollNote
            {
                constructor() {
    ...
    var require_types = __commonJS({
        "node_modules/tja/dist/models/note/types/index.js"(exports) {
            ...
            Object.defineProperty(exports, "BlankNote", {
                enumerable: true,
                get: function() {
            ...
            Object.defineProperty(exports, "Don", {
                enumerable: true,
                get: function() {
                    return Don_1.Don;
                },
            ...
            Object.defineProperty(exports, "BigDon", {
                enumerable: true,
                get: function() {
            ...
            Object.defineProperty(exports, "BigKa", {
                enumerable: true,
                get: function() {
            ...
            Object.defineProperty(exports, "Drumroll", {
                enumerable: true,
                get: function() {
            ...
            Object.defineProperty(exports, "BigDrumroll", {
                enumerable: true,
                get: function() {
            ...
            Object.defineProperty(exports, "DrumrollEnd", {
                enumerable: true,
                get: function() {
            ...
            Object.defineProperty(exports, "Kusudama", {
                enumerable: true,
                get: function() {
            ...
            Object.defineProperty(exports, "MultiDon", {
                enumerable: true,
                get: function() {
            ...
            Object.defineProperty(exports, "MultiKa", {
                enumerable: true,
                get: function() {
            ...
            Object.defineProperty(exports, "ADLIB", {
                enumerable: true,
                get: function() {
            ...
            Object.defineProperty(exports, "MeasureEnd", {
                enumerable: true,
                get: function() {
        ...
        "node_modules/tja/dist/models/command/types/NoteSequence.js"(exports) {
            ...
            var NoteSequence = class _NoteSequence extends Command_1.Command {
                ...
                static parse(args, strict = true) {
                    ...
                    const rawNotes = args.join("").replace(
                        regex_1.SPACE_REGEX,
                        "",
                    ).split("");
                    rawNotes.forEach((rawNote) => {
                        const note = NoteFactory_1.NoteFactory.fromCourseValue(
                            rawNote,
                            strict,
                        );
                        if (note) {
    ...
    var require_types2 = __commonJS({
        "node_modules/tja/dist/models/command/types/index.js"(exports) {
            "use strict";
            Object.defineProperty(exports, "__esModule", { value: true });
            exports.NoteSequence =
                exports.MasterBranchMarkerCommand =
                exports.AdvancedBranchMarkerCommand =
                exports.NormalBranchMarkerCommand =
                exports.BranchMarkerCommand =
                exports.JPosScrollCommand =
                exports.SuddenCommand =
                exports.DirectionCommand =
                exports.NextSongCommand =
                exports.HBScrollCommand =
                exports.BMScrollCommand =
                exports.LevelHoldCommand =
                exports.LyricCommand =
                exports.SectionCommand =
                exports.BranchEndCommand =
                exports.BranchStartCommand =
                exports.BarLineOnCommand =
                exports.BarLineOffCommand =
                exports.GoGoEndCommand =
                exports.GoGoStartCommand =
                exports.ScrollCommand =
                exports.DelayCommand =
                exports.BPMChangeCommand =
            ...
            Object.defineProperty(exports, "EndCommand", {
                enumerable: true,
                get: function() {
            ...
            Object.defineProperty(exports, "MeasureCommand", {
                enumerable: true,
                get: function() {
            ...
            Object.defineProperty(exports, "BPMChangeCommand", {
                enumerable: true,
                get: function() {
            ...
            Object.defineProperty(exports, "DelayCommand", {
                enumerable: true,
                get: function() {
            ...
            Object.defineProperty(exports, "ScrollCommand", {
                enumerable: true,
                get: function() {
            ...
            Object.defineProperty(exports, "GoGoStartCommand", {
                enumerable: true,
                get: function() {
            ...
            Object.defineProperty(exports, "GoGoEndCommand", {
                enumerable: true,
                get: function() {
            ...
            Object.defineProperty(exports, "BarLineOffCommand", {
                enumerable: true,
                get: function() {
            ...
            Object.defineProperty(exports, "BarLineOnCommand", {
                enumerable: true,
                get: function() {
            ...
            Object.defineProperty(exports, "BranchStartCommand", {
                enumerable: true,
                get: function() {
            ...
            Object.defineProperty(exports, "BranchEndCommand", {
                enumerable: true,
                get: function() {
            ...
            Object.defineProperty(exports, "SectionCommand", {
                enumerable: true,
                get: function() {
            ...
            Object.defineProperty(exports, "LyricCommand", {
                enumerable: true,
                get: function() {
            ...
            Object.defineProperty(exports, "LevelHoldCommand", {
                enumerable: true,
                get: function() {
            ...
            Object.defineProperty(exports, "BMScrollCommand", {
                enumerable: true,
                get: function() {
            ...
            Object.defineProperty(exports, "HBScrollCommand", {
                enumerable: true,
                get: function() {
            ...
            Object.defineProperty(exports, "NextSongCommand", {
                enumerable: true,
                get: function() {
            ...
            Object.defineProperty(exports, "DirectionCommand", {
                enumerable: true,
                get: function() {
            ...
            Object.defineProperty(exports, "SuddenCommand", {
                enumerable: true,
                get: function() {
            ...
            Object.defineProperty(exports, "JPosScrollCommand", {
                enumerable: true,
                get: function() {
            ...
            Object.defineProperty(exports, "BranchMarkerCommand", {
                enumerable: true,
                get: function() {
                    return BranchMarkerCommand_1.BranchMarkerCommand;
                },
            });
            Object.defineProperty(exports, "NormalBranchMarkerCommand", {
                enumerable: true,
                get: function() {
                    return BranchMarkerCommand_1.NormalBranchMarkerCommand;
                },
            });
            Object.defineProperty(exports, "AdvancedBranchMarkerCommand", {
                enumerable: true,
                get: function() {
                    return BranchMarkerCommand_1.AdvancedBranchMarkerCommand;
                },
            });
            Object.defineProperty(exports, "MasterBranchMarkerCommand", {
                enumerable: true,
                get: function() {
            ...
            Object.defineProperty(exports, "NoteSequence", {
                enumerable: true,
                get: function() {
    ...
    var require_commandClassMap = __commonJS({
        "node_modules/tja/dist/models/command/lib/commandClassMap.js"(
            ...
            exports.commandClassMap = {
                ...
                [CommandType_1.CommandType.BarLineOff]:
                    types_1.BarLineOffCommand,
                [CommandType_1.CommandType.BarLineOn]: types_1.BarLineOnCommand,
                [CommandType_1.CommandType.BranchStart]:
                    types_1.BranchStartCommand,
        ...
        "node_modules/tja/dist/models/command/CommandFactory.js"(exports) {
            ...
            var CommandFactory = class {
                static fromLine(line, canParseNotes, strict = true) {
                    ...
                    if (
                        !Object.keys(commandClassMap_1.commandClassMap)
                            .includes(command)
                    ) {
                        return void 0;
                    }
                    const commandClass =
                        commandClassMap_1.commandClassMap[command];
    ...
    var require_DojoGaugeCondition = __commonJS({
        "node_modules/tja/dist/models/course/lib/DojoGaugeCondition.js"(
            ...
            var DojoGaugeCondition = class _DojoGaugeCondition {
                ...
                static fromId(id, strict = true) {
                    const item = _DojoGaugeCondition._values.find((it2) =>
                        it2._id === id
                    );
                    if (item) {
                        return item;
                    ...
                    if (strict) {
                        throw new Error(
                            `Invalid DojoGaugeCondition id: ${id}`,
                        );
                    }
                }
                static fromRaw(raw, strict = true) {
    ...
    var require_DojoGaugeScope = __commonJS({
        "node_modules/tja/dist/models/course/lib/DojoGaugeScope.js"(exports) {
            ...
            var DojoGaugeScope = class _DojoGaugeScope {
                ...
                static fromId(id, strict = true) {
                    const item = _DojoGaugeScope._values.find((it2) =>
                        it2._id === id
                    );
                    if (item) {
                        return item;
        ...
        "node_modules/tja/dist/models/course/DojoGauge.js"(exports) {
            ...
            var DojoGauge = class _DojoGauge {
                ...
                static parse(raw, strict = true) {
                    ...
                    const condition = DojoGaugeCondition_1.DojoGaugeCondition
                        .fromRaw(components[0]);
                    const redClearRequirement = parseInt(components[1], 10);
                    const goldClearRequirement = parseInt(components[2], 10);
                    const scope = DojoGaugeScope_1.DojoGaugeScope.fromRaw(
                        components[3],
                    );
                    if (
                        !condition || isNaN(redClearRequirement)
                        || isNaN(goldClearRequirement) || !scope
                    ) {
                        if (strict) {
                            throw new Error(`Invalid gauge value: ${raw}`);
                        }
                    }
                    return new _DojoGauge(
                        condition,
                        redClearRequirement,
                        goldClearRequirement,
                        scope,
    ...
    var require_DojoGaugeIncrementMethod = __commonJS({
        "node_modules/tja/dist/models/course/lib/DojoGaugeIncrementMethod.js"(
            ...
            var DojoGaugeIncrementMethod = class _DojoGaugeIncrementMethod {
                ...
                static fromName(name, strict = true) {
                    const item = _DojoGaugeIncrementMethod._values.find((
                        it2,
                    ) => it2._name === name);
                    if (item) {
                        return item;
                    ...
                    if (strict) {
                        throw new Error(
                            `Invalid gauge increment method: ${name}`,
                        );
                    }
                }
                static fromRaw(raw, strict = true) {
            ...
            DojoGaugeIncrementMethod.Normal = new DojoGaugeIncrementMethod(
                "Normal",
            );
            DojoGaugeIncrementMethod.Floor = new DojoGaugeIncrementMethod(
                "Floor",
            );
            DojoGaugeIncrementMethod.Round = new DojoGaugeIncrementMethod(
                "Round",
            );
            DojoGaugeIncrementMethod.Notfix = new DojoGaugeIncrementMethod(
                "Notfix",
            );
            DojoGaugeIncrementMethod.Ceiling = new DojoGaugeIncrementMethod(
                "Ceiling",
            );
    ...
    var require_Parser = __commonJS({
        "node_modules/tja/dist/Parser.js"(exports) {
            ...
            var TJAParser2 = class _TJAParser {
                 ...
                 */
                static parse(raw, strict = true) {
                    const lines = raw.split(regex_1.LINE_REGEX).map((l) =>
                        l.trim().split("//")[0]
                    );
                    ...
                    while (!queue.isEmpty) {
                        ...
                        if (params) {
                            ...
                            const course2 =
                                song.courses[song.courses.length - 1];
                            if (typeof course2 === "undefined") {
                                continue;
                            }
                            _TJAParser.setCourseData(
                                course2,
                                key,
                                value,
                                strict,
                        ...
                        const command = _TJAParser.parseCourseCommand(
                            course,
                            line,
                            canParseNotes,
                            strict,
                        ...
                        if (
                            command
                            && command.commandType
                                === CommandType_1.CommandType.Start
                        ) {
                            canParseNotes = true;
                        }
                    }
                ...
                static setSongData(song, key, value, strict) {
                    ...
                    if (
                        key === MetadataProperty_1.SongMetadataProperty.TitleEN
                    ) {
                        song.localizedTitle.en = value;
                        return;
                    }
                    if (
                        key === MetadataProperty_1.SongMetadataProperty.TitleJA
                    ) {
                        song.localizedTitle.ja = value;
                        return;
                    }
                    if (
                        key === MetadataProperty_1.SongMetadataProperty.TitleCN
                    ) {
                        song.localizedTitle.cn = value;
                        return;
                    }
                    if (
                        key === MetadataProperty_1.SongMetadataProperty.TitleTW
                    ) {
                        song.localizedTitle.tw = value;
                        return;
                    }
                    if (
                        key === MetadataProperty_1.SongMetadataProperty.TitleKO
                    ) {
                        song.localizedTitle.ko = value;
                        return;
                    }
                    if (
                        key === MetadataProperty_1.SongMetadataProperty.Subtitle
                    ) {
                        song.subtitle = value;
                        return;
                    }
                    if (
                        key
                            === MetadataProperty_1.SongMetadataProperty
                                .SubtitleEN
                    ) {
                    ...
                    if (
                        key === MetadataProperty_1.SongMetadataProperty.Offset
                    ) {
                    ...
                    if (
                        ...
                        if (!isNaN(demoStart)) {
                            ...
                            throw new TypeError(
                                `Invalid demo start value: ${value}`,
                            );
                        }
                        return;
                    }
                    ...
                    if (
                        ...
                        const mode = ScoreMode_1.ScoreMode.fromRaw(
                            value,
                            strict,
                        );
                        if (mode) {
                    ...
                    if (
                        key === MetadataProperty_1.SongMetadataProperty.Lyrics
                    ) {
                        song.lyricsFilePath = value;
                        return;
                    }
                    if (
                        key === MetadataProperty_1.SongMetadataProperty.SongVol
                    ) {
                        ...
                        if (!isNaN(volume)) {
                            ...
                            throw new TypeError(
                                `Invalid song volume value: ${value}`,
                            );
                        }
                        return;
                    }
                    if (key === MetadataProperty_1.SongMetadataProperty.SEVol) {
                        ...
                        if (!isNaN(volume)) {
                            ...
                            throw new TypeError(
                                `Invalid sound effect volume value: ${value}`,
                            );
                        }
                        return;
                    }
                    ...
                    if (
                        ...
                        if (!isNaN(headScroll)) {
                            ...
                            throw new TypeError(
                                `Invalid head scroll value: ${value}`,
                            );
                        }
                        return;
                    }
                    if (
                        key === MetadataProperty_1.SongMetadataProperty.BGImage
                    ) {
                        song.backgroundImagePath = value;
                        return;
                    }
                    if (
                        key === MetadataProperty_1.SongMetadataProperty.BGMovie
                    ) {
                    ...
                    if (
                        ...
                        if (!isNaN(movieOffset)) {
                            ...
                            throw new TypeError(
                                `Invalid movie offset value: ${value}`,
                            );
                        }
                        return;
                    }
                ...
                static setCourseData(course, key, value, strict) {
                    if (
                        key === MetadataProperty_1.CourseMetadataProperty.Course
                    ) {
                        const difficulty = Difficulty_1.Difficulty.fromRaw(
                            value,
                            strict,
                        );
                        if (difficulty) {
                    ...
                    if (
                        key === MetadataProperty_1.CourseMetadataProperty.Level
                    ) {
                        ...
                        if (!isNaN(level)) {
                            ...
                            throw new TypeError(
                                `Invalid course level value: ${value}`,
                            );
                        }
                        return;
                    }
                    if (
                        key
                            === MetadataProperty_1.CourseMetadataProperty
                                .ScoreInit
                    ) {
                        ...
                        if (!isNaN(scoreInit)) {
                            ...
                            throw new TypeError(
                                `Invalid course score init value: ${value}`,
                            );
                        }
                        return;
                    }
                    if (
                        ...
                        if (!isNaN(scoreDiff)) {
                            ...
                            throw new TypeError(
                                `Invalid course score diff value: ${value}`,
                            );
                        }
                        return;
                    }
                    if (
                        ...
                        const counts = value.split(",").filter((c) =>
                            c.trim().length > 0
                        ...
                        if (filteredCounts.length === counts.length) {
                            ...
                            throw new TypeError(
                                `Invalid course balloon value: ${value}`,
                            );
                        }
                        return;
                    }
                    if (
                        ...
                        const counts = value.split(",").map((c) =>
                            parseInt(c.trim(), 10)
                        );
                        const filteredCounts = counts.filter((c) => !isNaN(c));
                        if (filteredCounts.length === counts.length) {
                            ...
                            throw new TypeError(
                                `Invalid course balloon (normal) value: ${value}`,
                            );
                        }
                        return;
                    }
                    ...
                    if (
                        ...
                        if (filteredCounts.length === counts.length) {
                            ...
                            throw new TypeError(
                                `Invalid course balloon (master) value: ${value}`,
                            );
                        }
                        return;
                    }
                    if (
                        key === MetadataProperty_1.CourseMetadataProperty.Style
                    ) {
                    ...
                    if (
                        ...
                        const gauge = DojoGauge_1.DojoGauge.parse(
                            value,
                            strict,
                        );
                        if (gauge) {
                    ...
                    if (
                        ...
                        const gaugeIncrementMethod = DojoGaugeIncrementMethod_1
                            .DojoGaugeIncrementMethod.fromRaw(value, strict);
                        if (gaugeIncrementMethod) {
                            course.activeCourse.gaugeIncrementMethod =
                                gaugeIncrementMethod;
                        }
                        return;
                    }
                    if (
                        key === MetadataProperty_1.CourseMetadataProperty.Total
                    ) {
                        const rawTotal = parseInt(value, 10);
                        if (!isNaN(rawTotal)) {
                            const total = new DojoGaugeTotal_1.DojoGaugeTotal(
                                rawTotal,
                            );
                            course.activeCourse.gaugeTotal = total;
                        } else if (strict) {
                            throw new TypeError(
                                `Invalid gauge total value: ${value}`,
                            );
                        }
                        return;
                    }
                    if (
                        key
                            === MetadataProperty_1.CourseMetadataProperty
                                .HiddenBranch && value === "1"
                    ) {
                        course.activeCourse.hiddenBranches = true;
                        return;
                    }
                }
                static parseCourseCommand(
                    course,
                    line,
                    canParseNotes,
                    strict,
                ) {
                    const command = CommandFactory_1.CommandFactory.fromLine(
                        line,
                        canParseNotes,
                        strict,
                    );
    ...
    var require_dist = __commonJS({
        "node_modules/tja/dist/index.js"(exports) {
            ...
            exports.TJAParser =
                ...
                exports.Game =
                exports.Note =
                exports.CountableDrumrollNote =
                exports.NoteType =
                exports.DojoGauge =
                exports.CourseVariant =
                exports.Course =
                exports.DojoGaugeScope =
                exports.DojoGaugeCondition =
                exports.DojoGaugeTotal =
                exports.DojoGaugeIncrementMethod =
                exports.Style =
                exports.MeasureValue =
                exports.Difficulty =
                exports.ScrollDirection =
                exports.Player =
                exports.JPosScrollDirection =
                exports.Command =
                exports.CommandType =
                exports.BranchType =
                exports.BranchRequirementType =
                    void 0;
            var Parser_1 = require_Parser();
            Object.defineProperty(exports, "TJAParser", {
                enumerable: true,
                get: function() {
            ...
            var BranchRequirementType_1 = require_BranchRequirementType();
            Object.defineProperty(exports, "BranchRequirementType", {
                enumerable: true,
                get: function() {
            ...
            var BranchType_1 = require_BranchType();
            Object.defineProperty(exports, "BranchType", {
                enumerable: true,
                get: function() {
            ...
            var CommandType_1 = require_CommandType();
            Object.defineProperty(exports, "CommandType", {
                enumerable: true,
                get: function() {
            ...
            var JPosScrollDirection_1 = require_JPosScrollDirection();
            Object.defineProperty(exports, "JPosScrollDirection", {
                enumerable: true,
                get: function() {
            ...
            var MeasureValue_1 = require_MeasureValue();
            Object.defineProperty(exports, "MeasureValue", {
                enumerable: true,
                get: function() {
            ...
            var DojoGaugeIncrementMethod_1 = require_DojoGaugeIncrementMethod();
            Object.defineProperty(exports, "DojoGaugeIncrementMethod", {
                enumerable: true,
                get: function() {
            ...
            var DojoGaugeTotal_1 = require_DojoGaugeTotal();
            Object.defineProperty(exports, "DojoGaugeTotal", {
                enumerable: true,
                get: function() {
            ...
            var DojoGaugeCondition_1 = require_DojoGaugeCondition();
            Object.defineProperty(exports, "DojoGaugeCondition", {
                enumerable: true,
                get: function() {
            ...
            var DojoGaugeScope_1 = require_DojoGaugeScope();
            Object.defineProperty(exports, "DojoGaugeScope", {
                enumerable: true,
                get: function() {
            ...
            var CourseVariant_1 = require_CourseVariant();
            Object.defineProperty(exports, "CourseVariant", {
                enumerable: true,
                get: function() {
            ...
            var DojoGauge_1 = require_DojoGauge();
            Object.defineProperty(exports, "DojoGauge", {
                enumerable: true,
                get: function() {
            ...
            var NoteType_1 = require_NoteType();
            Object.defineProperty(exports, "NoteType", {
                enumerable: true,
                get: function() {
            ...
            var CountableDrumrollNote_1 = require_CountableDrumrollNote();
            Object.defineProperty(exports, "CountableDrumrollNote", {
                enumerable: true,
                get: function() {
            ...
            var ScoreMode_1 = require_ScoreMode();
            Object.defineProperty(exports, "ScoreMode", {
                enumerable: true,
                get: function() {
    ...
    var gr = (() => {
        ...
        return (o) => {
            for (
                ...
                var I = n14[o.charCodeAt(m++)],
                    j = n14[o.charCodeAt(m++)],
                    y2 = n14[o.charCodeAt(m++)],
                    X = n14[o.charCodeAt(m++)];
                g[P++] = I << 2 | j >> 4,
                    g[P++] = j << 4 | y2 >> 2,
                    g[P++] = y2 << 6 | X;
            }
    ...
    function Ve(n14, e, o) {
        ...
        throw new Error(
            `Bad value for lerp(): ${n14}, ${e}. Only number, Vec2 and Color is supported.`,
        );
    }
    i(Ve, "lerp");
    ...
    var v = class n {
        ...
        slerp(e, o) {
            ...
            return this.scale(Math.sin((1 - o) * m)).add(
                e.scale(Math.sin(o * m)),
            ).scale(1 / g);
        }
        isZero() {
        ...
        toFixed(e) {
            return new n(
                Number(this.x.toFixed(e)),
                Number(this.y.toFixed(e)),
            );
        }
        transform(e) {
    ...
    var oe = class n3 {
        ...
        eq(e) {
            return this.x === e.x && this.y === e.y && this.w === e.w
                && this.h === e.h;
        }
        toString() {
    ...
    var Ue = class n4 {
        ...
        mult(e) {
            ...
            for (let c = 0; c < 4; c++) {
                for (let g = 0; g < 4; g++) {
                    o[c * 4 + g] = this.m[0 * 4 + g] * e.m[c * 4 + 0]
                        + this.m[1 * 4 + g] * e.m[c * 4 + 1]
                        + this.m[2 * 4 + g] * e.m[c * 4 + 2]
                        + this.m[3 * 4 + g] * e.m[c * 4 + 3];
                }
            }
            return new n4(o);
        }
        ...
        getScale() {
            if (this.m[0] != 0 || this.m[1] != 0) {
                let e = this.m[0] * this.m[5] - this.m[1] * this.m[4],
                    o = Math.sqrt(
                        this.m[0] * this.m[0] + this.m[1] * this.m[1],
                    );
                return new v(o, e / o);
            } else if (this.m[4] != 0 || this.m[5] != 0) {
                let e = this.m[0] * this.m[5] - this.m[1] * this.m[4],
                    o = Math.sqrt(
                        this.m[4] * this.m[4] + this.m[5] * this.m[5],
                    );
                return new v(e / o, o);
            } else {
                return new v(0, 0);
        ...
        invert() {
            let e = [],
                ...
                g = this.m[9] * this.m[14] - this.m[13] * this.m[10],
                ...
                y2 = this.m[5] * this.m[15] - this.m[13] * this.m[7],
                ...
                k2 = this.m[5] * this.m[10] - this.m[9] * this.m[6],
                pe = this.m[4] * this.m[11] - this.m[8] * this.m[7],
                C = this.m[4] * this.m[10] - this.m[8] * this.m[6],
                Ae = this.m[4] * this.m[9] - this.m[8] * this.m[5];
            e[0] = this.m[5] * o - this.m[6] * c + this.m[7] * g,
                e[4] = -(this.m[4] * o - this.m[6] * m + this.m[7] * P),
                e[8] = this.m[4] * c - this.m[5] * m + this.m[7] * I,
                e[12] = -(this.m[4] * g - this.m[5] * P + this.m[6] * I),
                e[1] = -(this.m[1] * o - this.m[2] * c + this.m[3] * g),
                e[5] = this.m[0] * o - this.m[2] * m + this.m[3] * P,
                e[9] = -(this.m[0] * c - this.m[1] * m + this.m[3] * I),
                e[13] = this.m[0] * g - this.m[1] * P + this.m[2] * I,
                e[2] = this.m[1] * j - this.m[2] * y2 + this.m[3] * X,
                e[6] = -(this.m[0] * j - this.m[2] * S + this.m[3] * q),
                e[10] = this.m[0] * E - this.m[1] * S + this.m[3] * K,
                e[14] = -(this.m[0] * X - this.m[1] * q + this.m[2] * K),
                e[3] = -(this.m[1] * Q - this.m[2] * te + this.m[3] * k2),
                e[7] = this.m[0] * Q - this.m[2] * pe + this.m[3] * C,
                e[11] = -(this.m[0] * te - this.m[1] * pe + this.m[3] * Ae),
                e[15] = this.m[0] * k2 - this.m[1] * C + this.m[2] * Ae;
            let $ = this.m[0] * e[0] + this.m[1] * e[4] + this.m[2] * e[8]
                + this.m[3] * e[12];
    ...
    i(Ur, "choose");
    function Er(n14, e) {
        return n14.pos.x + n14.width > e.pos.x && n14.pos.x < e.pos.x + e.width
            && n14.pos.y + n14.height > e.pos.y
            && n14.pos.y < e.pos.y + e.height;
    }
    i(Er, "testRectRect");
    function Ei(n14, e) {
        if (
            n14.p1.x === n14.p2.x && n14.p1.y === n14.p2.y
            || e.p1.x === e.p2.x && e.p1.y === e.p2.y
        ) {
            return null;
        }
        let o = (e.p2.y - e.p1.y) * (n14.p2.x - n14.p1.x)
            - (e.p2.x - e.p1.x) * (n14.p2.y - n14.p1.y);
        if (o === 0) {
            return null;
        }
        let c = ((e.p2.x - e.p1.x) * (n14.p1.y - e.p1.y)
                - (e.p2.y - e.p1.y) * (n14.p1.x - e.p1.x)) / o,
            g = ((n14.p2.x - n14.p1.x) * (n14.p1.y - e.p1.y)
                - (n14.p2.y - n14.p1.y) * (n14.p1.x - e.p1.x)) / o;
    ...
    function it(n14, e) {
        ...
        return o
            ? T(
                n14.p1.x + o * (n14.p2.x - n14.p1.x),
                n14.p1.y + o * (n14.p2.y - n14.p1.y),
            )
            : null;
    }
    i(it, "testLineLine");
    function Sr(n14, e) {
        ...
        let o = n14.points();
        return !!it(e, new Ie(o[0], o[1])) || !!it(e, new Ie(o[1], o[2]))
            || !!it(e, new Ie(o[2], o[3])) || !!it(e, new Ie(o[3], o[0]));
    }
    i(Sr, "testRectLine");
    function vt(n14, e) {
        return e.x > n14.pos.x && e.x < n14.pos.x + n14.width && e.y > n14.pos.y
            && e.y < n14.pos.y + n14.height;
    }
    i(vt, "testRectPoint");
    function Cr(n14, e) {
    ...
    i(Cr, "testLinePoint");
    function Vn(n14, e) {
        let o = n14.p2.sub(n14.p1),
            c = o.dot(o),
            g = n14.p1.sub(e.center),
            m = 2 * o.dot(g),
            P = g.dot(g) - e.radius * e.radius,
            I = m * m - 4 * c * P;
        ...
        if (I == 0) {
            ...
            let j = (-m + Math.sqrt(I)) / (2 * c),
                y2 = (-m - Math.sqrt(I)) / (2 * c);
    ...
    function _n(n14, e) {
        ...
        for (let g = 0, m = c.length - 1; g < c.length; m = g++) {
            c[g].y > e.y != c[m].y > e.y
                && e.x
                    < (c[m].x - c[g].x) * (e.y - c[g].y) / (c[m].y - c[g].y)
                        + c[g].x
                && (o = !o);
        }
        return o;
    ...
    var de = class n6 {
        ...
        sdistToPoint(e) {
            let o = this.pos,
                ...
                g = Math.max(o.x - e.x, 0, e.x - c.x),
                m = Math.max(o.y - e.y, 0, e.y - c.y);
            return g * g + m * m;
        }
    };
    var yt = class n7 {
        ...
        bbox() {
            ...
            for (let c of this.pts) {
                e.x = Math.min(e.x, c.x),
                    o.x = Math.max(o.x, c.x),
                    e.y = Math.min(e.y, c.y),
                    o.y = Math.max(o.y, c.y);
            }
    ...
    function Or(n14, e) {
        ...
        for (let g of [n14, e]) {
            for (let m = 0; m < g.pts.length; m++) {
                let P = g.pts[m],
                    j = g.pts[(m + 1) % g.pts.length].sub(P).normal().unit(),
                    y2 = Number.MAX_VALUE,
                    X = -Number.MAX_VALUE;
    ...
    var Br = i(
        (n14) => n14 instanceof Error ? n14.message : String(n14),
        "getErrorMessage",
    );
    var Yt = class {
        static {
        ...
        remove() {
            ...
            return this._items.length !== 0
                && (this._items[0] = o, this.moveDown(0)),
                e;
        }
        clear() {
        ...
        moveDown(e) {
            for (; e < Math.floor(this._items.length / 2);) {
                ...
                if (
                    ...
                    && ++o, this._compareFn(this._items[e], this._items[o])
                ) {
                    break;
                }
                this.swap(e, o), e = o;
    ...
    function Ai(n14, e) {
        ...
        return Rr(c) && Rr(g)
            ? 4
            : Oi(c) && Mi(g)
            ? e.slice(n14).indexOf(String.fromCodePoint(917631)) + 2
            : Ri(g)
            ? 4
            : 2;
    }
    ...
    function Mi(n14) {
        ...
        return typeof n14 == "string" && typeof e == "number"
            && tt(e, 917504, 917631);
    }
    ...
    var Ir = i((n14) => {
        ...
        let e = {
            ...
            charInputted: [],
            isMouseMoved: false,
            lastWidth: n14.canvas.offsetWidth,
            lastHeight: n14.canvas.offsetHeight,
            events: new Ne(),
        };
        function o() {
        ...
        function Tt(l) {
            return l === void 0
                ? e.keyState.down.size > 0
                : e.keyState.down.has(l);
        }
        i(Tt, "isKeyDown");
        function Ot(l) {
            return l === void 0
        ...
        let cn = Ee(
                ...
                (l, x2) => e.events.on("keyDown", (R) => R === l && x2(l)),
            ),
            hn = Ee(
                (l) => e.events.on("keyPress", l),
                (l, x2) => e.events.on("keyPress", (R) => R === l && x2(l)),
            ),
            ln = Ee(
                (l) => e.events.on("keyPressRepeat", l),
                (l, x2) =>
                    e.events.on("keyPressRepeat", (R) => R === l && x2(l)),
            ),
            dn = Ee(
                (l) => e.events.on("keyRelease", l),
                (l, x2) => e.events.on("keyRelease", (R) => R === l && x2(l)),
            ),
            Pt = Ee(
                (l) => e.events.on("mouseDown", (x2) => l(x2)),
                (l, x2) => e.events.on("mouseDown", (R) => R === l && x2(R)),
            ),
            Dt = Ee(
                (l) => e.events.on("mousePress", (x2) => l(x2)),
                (l, x2) => e.events.on("mousePress", (R) => R === l && x2(R)),
            ),
            Mt = Ee(
                (l) => e.events.on("mouseRelease", (x2) => l(x2)),
                (l, x2) => e.events.on("mouseRelease", (R) => R === l && x2(R)),
            );
        function Gt(l) {
        ...
        function ft() {
            e.events.trigger("input"),
                ...
                e.mouseState.down.forEach((l) =>
                    e.events.trigger("mouseDown", l)
                ),
                He();
        }
        i(ft, "processInput");
        ...
        function ne(l) {
            e.gamepads = e.gamepads.filter((x2) => x2.index !== l.index),
        ...
        function He() {
            ...
            for (let l of e.gamepads) {
                let x2 = navigator.getGamepads()[l.index],
                    L = (n14.gamepads ?? {})[x2.id] ?? qn[x2.id] ?? qn.default,
                    he = e.gamepadStates.get(l.index);
                for (let z = 0; z < x2.buttons.length; z++) {
                    x2.buttons[z].pressed
                        ? (he.buttonState.down.has(L.buttons[z])
                            || (e.mergedGamepadState.buttonState.press(
                                L.buttons[z],
                            ),
                        ...
                        : he.buttonState.down.has(L.buttons[z])
                            && (e.mergedGamepadState.buttonState.release(
                                L.buttons[z],
                            ),
                ...
                for (let z in L.sticks) {
                    let Oe = L.sticks[z],
                        $e = new v(x2.axes[Oe.x], x2.axes[Oe.y]);
        ...
        let se = {},
            le = {},
            ae = {},
            Be = n14.pixelDensity || window.devicePixelRatio || 1;
        se.mousemove = (l) => {
            let x2 = new v(l.offsetX, l.offsetY),
            ...
            if (Q()) {
                ...
                if ($e > kt) {
                    ...
                    x2.x = _e(l.offsetX - Ce, 0, L * De, 0, L),
                        x2.y = _e(l.offsetY, 0, he * De, 0, he);
                } else {
                    let De = z / L, Ce = (Oe - he * De) / 2;
                    x2.x = _e(l.offsetX, 0, L * De, 0, L),
                        x2.y = _e(l.offsetY - Ce, 0, he * De, 0, he);
                }
            }
        ...
        se.mousedown = (l) => {
            e.events.onOnce("input", () => {
                let x2 = We[l.button];
                x2
                    && (e.mouseState.press(x2),
                        e.events.trigger("mousePress", x2));
            });
        },
            se.mouseup = (l) => {
                e.events.onOnce("input", () => {
                    let x2 = We[l.button];
                    x2
                        && (e.mouseState.release(x2),
                            e.events.trigger("mouseRelease", x2));
                });
            };
        ...
        se.keydown = (l) => {
            yn.has(l.key) && l.preventDefault(),
                e.events.onOnce("input", () => {
                    let x2 = qe[l.key] || l.key.toLowerCase();
                    x2.length === 1
                        ? (e.events.trigger("charInput", x2),
                            e.charInputted.push(x2))
                        : x2 === "space"
                            && (e.events.trigger("charInput", " "),
                                e.charInputted.push(" ")),
                        l.repeat
                            ? (e.keyState.pressRepeat(x2),
                                e.events.trigger("keyPressRepeat", x2))
                            : (e.keyState.press(x2),
                                e.events.trigger("keyPressRepeat", x2),
                                e.events.trigger("keyPress", x2));
                });
        },
            se.keyup = (l) => {
                e.events.onOnce("input", () => {
            ...
            se.touchstart = (l) => {
                l.preventDefault(),
                    e.events.onOnce("input", () => {
                        let x2 = [...l.changedTouches],
                            R = e.canvas.getBoundingClientRect();
                        n14.touchToMouse !== false
                        && (e.mousePos = new v(
                            x2[0].clientX - R.x,
                            x2[0].clientY - R.y,
                        ),
            ...
            le.visibilitychange = () => {
                document.visibilityState === "visible"
                    ? (e.skipTime = true, e.events.trigger("show"))
    ...
    var Re = class n11 {
        ...
        constructor(e, o, c, g = {}) {
            ...
            let P = {
                    linear: m.LINEAR,
                    nearest: m.NEAREST,
                }[g.filter ?? e.opts.texFilter] ?? m.NEAREST,
                I = { repeat: m.REPEAT, clampToEadge: m.CLAMP_TO_EDGE }[g.wrap]
                    ?? m.CLAMP_TO_EDGE;
            this.bind(),
                o && c
                && m.texImage2D(
                ...
                m.texParameteri(m.TEXTURE_2D, m.TEXTURE_MIN_FILTER, P),
                m.texParameteri(m.TEXTURE_2D, m.TEXTURE_MAG_FILTER, P),
                m.texParameteri(m.TEXTURE_2D, m.TEXTURE_WRAP_S, I),
                m.texParameteri(m.TEXTURE_2D, m.TEXTURE_WRAP_T, I),
                this.unbind();
        }
    ...
    var rt = class {
        ...
        constructor(e, o, c, g = {}) {
            ...
            let m = e.gl;
            e.onDestroy(() => this.free()),
                this.tex = new Re(e, o, c, g),
                this.glFramebuffer = m.createFramebuffer(),
                this.glRenderbuffer = m.createRenderbuffer(),
                this.bind(),
                m.renderbufferStorage(m.RENDERBUFFER, m.DEPTH_STENCIL, o, c),
        ...
        toImageData() {
            ...
            for (let m = 0; m < (this.height / 2 | 0); m++) {
                ...
                g.set(o.subarray(P, P + c)),
                    o.copyWithin(P, I, I + c),
                    o.set(g, I);
            }
        ...
        constructor(e, o, c, g) {
            ...
            if (
                this.glProgram = j,
                    m.attachShader(j, P),
                    m.attachShader(j, I),
                    g.forEach((y2, X) => m.bindAttribLocation(j, X, y2)),
                    m.linkProgram(j),
                    !m.getProgramParameter(j, m.LINK_STATUS)
            ) {
        ...
        send(e) {
            ...
            for (let c in e) {
                ...
                typeof g == "number"
                    ? o.uniform1f(m, g)
                    : g instanceof Ue
                    ? o.uniformMatrix4fv(m, false, new Float32Array(g.m))
                    : g instanceof W
                    ? o.uniform3f(m, g.r, g.g, g.b)
                    : g instanceof v && o.uniform2f(m, g.x, g.y);
            }
        }
        free() {
    ...
    var Qt = class {
        ...
        constructor(e, o, c, g) {
            ...
            this.vertexFormat = o,
                this.ctx = e,
                this.stride = o.reduce((P, I) => P + I.size, 0),
                this.maxVertices = c,
                this.maxIndices = g,
                this.glVBuf = m.createBuffer(),
                e.pushArrayBuffer(this.glVBuf),
                m.bufferData(m.ARRAY_BUFFER, c * 4, m.DYNAMIC_DRAW),
                e.popArrayBuffer(),
                this.glIBuf = m.createBuffer(),
                e.pushElementArrayBuffer(this.glIBuf),
                m.bufferData(m.ELEMENT_ARRAY_BUFFER, g * 4, m.DYNAMIC_DRAW),
                e.popElementArrayBuffer();
        }
        push(e, o, c, g, m = null, P = {}) {
            (e !== this.curPrimitive || m !== this.curTex
                || g !== this.curShader || !Wt(this.curUniform, P)
                || this.vqueue.length + o.length * this.stride
                    > this.maxVertices
        ...
        flush() {
            if (
                !this.curPrimitive || !this.curShader
                || this.vqueue.length === 0 || this.iqueue.length === 0
            ) {
                return;
            }
            let e = this.ctx.gl;
    ...
    function Kn(n14, e = {}) {
        ...
        function g() {
            o.forEach(($) => $()),
                n14.getExtension("WEBGL_lose_context").loseContext();
        }
        i(g, "destroy");
        let m = null;
        function P($) {
            ...
            $.reduce(
                (
                    ...
                    n14.enableVertexAttribArray(st),
                    ye + Se.size * 4),
                0,
            );
        }
        i(P, "setVertexFormat");
        let [I, j] = nt(($) => n14.bindTexture(n14.TEXTURE_2D, $)),
            [y2, X] = nt(($) => n14.bindBuffer(n14.ARRAY_BUFFER, $)),
            [S, q] = nt(($) => n14.bindBuffer(n14.ELEMENT_ARRAY_BUFFER, $)),
            [E, K] = nt(($) => n14.bindFramebuffer(n14.FRAMEBUFFER, $)),
            [Q, te] = nt(($) => n14.bindRenderbuffer(n14.RENDERBUFFER, $)),
            [k2, pe] = nt(({ x: $, y: Te, w: ye, h: Se }) => {
        ...
        return k2({
            x: 0,
            y: 0,
            w: n14.drawingBufferWidth,
            h: n14.drawingBufferHeight,
        }),
            {
                gl: n14,
                opts: e,
    ...
    function St(n14) {
        ...
        return e.crossOrigin = "anonymous",
            ...
            new Promise((o, c) => {
                e.onload = () => o(e),
                    e.onerror = () =>
                        c(new Error(`Failed to load image from "${n14}"`));
            });
    }
    i(St, "loadImg");
    var Zt = 2.5949095;
    ...
    var en = {
        linear: (n14) => n14,
        easeInSine: (n14) => 1 - Math.cos(n14 * Math.PI / 2),
        easeOutSine: (n14) => Math.sin(n14 * Math.PI / 2),
        easeInOutSine: (n14) => -(Math.cos(Math.PI * n14) - 1) / 2,
        easeInQuad: (n14) => n14 * n14,
        easeOutQuad: (n14) => 1 - (1 - n14) * (1 - n14),
        easeInOutQuad: (n14) =>
            n14 < 0.5 ? 2 * n14 * n14 : 1 - Math.pow(-2 * n14 + 2, 2) / 2,
        easeInCubic: (n14) => n14 * n14 * n14,
        easeOutCubic: (n14) => 1 - Math.pow(1 - n14, 3),
        easeInOutCubic: (n14) =>
            n14 < 0.5
                ? 4 * n14 * n14 * n14
                : 1 - Math.pow(-2 * n14 + 2, 3) / 2,
        easeInQuart: (n14) => n14 * n14 * n14 * n14,
        easeOutQuart: (n14) => 1 - Math.pow(1 - n14, 4),
        easeInOutQuart: (n14) =>
            n14 < 0.5
                ? 8 * n14 * n14 * n14 * n14
                : 1 - Math.pow(-2 * n14 + 2, 4) / 2,
        easeInQuint: (n14) => n14 * n14 * n14 * n14 * n14,
        easeOutQuint: (n14) => 1 - Math.pow(1 - n14, 5),
        easeInOutQuint: (n14) =>
            n14 < 0.5
                ? 16 * n14 * n14 * n14 * n14 * n14
                : 1 - Math.pow(-2 * n14 + 2, 5) / 2,
        easeInExpo: (n14) => n14 === 0 ? 0 : Math.pow(2, 10 * n14 - 10),
        easeOutExpo: (n14) => n14 === 1 ? 1 : 1 - Math.pow(2, -10 * n14),
        easeInOutExpo: (n14) =>
            n14 === 0
                ? 0
                : n14 === 1
                ? 1
                : n14 < 0.5
                ? Math.pow(2, 20 * n14 - 10) / 2
                : (2 - Math.pow(2, -20 * n14 + 10)) / 2,
        easeInCirc: (n14) => 1 - Math.sqrt(1 - Math.pow(n14, 2)),
        easeOutCirc: (n14) => Math.sqrt(1 - Math.pow(n14 - 1, 2)),
        easeInOutCirc: (n14) =>
            n14 < 0.5
                ? (1 - Math.sqrt(1 - Math.pow(2 * n14, 2))) / 2
                : (Math.sqrt(1 - Math.pow(-2 * n14 + 2, 2)) + 1) / 2,
        easeInBack: (n14) => _r * n14 * n14 * n14 - 1.70158 * n14 * n14,
        easeOutBack: (n14) =>
            1 + _r * Math.pow(n14 - 1, 3) + 1.70158 * Math.pow(n14 - 1, 2),
        easeInOutBack: (n14) =>
            n14 < 0.5
                ? Math.pow(2 * n14, 2) * ((Zt + 1) * 2 * n14 - Zt) / 2
                : (Math.pow(2 * n14 - 2, 2) * ((Zt + 1) * (n14 * 2 - 2) + Zt)
                    + 2) / 2,
        easeInElastic: (n14) =>
            n14 === 0
                ? 0
                : n14 === 1
                ? 1
                : -Math.pow(2, 10 * n14 - 10)
                    * Math.sin((n14 * 10 - 10.75) * kr),
        easeOutElastic: (n14) =>
            n14 === 0
                ? 0
                : n14 === 1
                ? 1
                : Math.pow(2, -10 * n14) * Math.sin((n14 * 10 - 0.75) * kr)
                    + 1,
        easeInOutElastic: (n14) =>
            n14 === 0
                ? 0
                : n14 === 1
                ? 1
                : n14 < 0.5
                ? -(Math.pow(2, 20 * n14 - 10)
                    * Math.sin((20 * n14 - 11.125) * Nr)) / 2
                : Math.pow(2, -20 * n14 + 10)
                        * Math.sin((20 * n14 - 11.125) * Nr) / 2 + 1,
        easeInBounce: (n14) => 1 - en.easeOutBounce(1 - n14),
        easeOutBounce: (n14) =>
            n14 < 1 / 2.75
                ? 7.5625 * n14 * n14
                : n14 < 2 / 2.75
                ? 7.5625 * (n14 -= 1.5 / 2.75) * n14 + 0.75
                : n14 < 2.5 / 2.75
                ? 7.5625 * (n14 -= 2.25 / 2.75) * n14 + 0.9375
                : 7.5625 * (n14 -= 2.625 / 2.75) * n14 + 0.984375,
        easeInOutBounce: (n14) =>
            n14 < 0.5
                ? (1 - en.easeOutBounce(1 - 2 * n14)) / 2
                : (1 + en.easeOutBounce(2 * n14 - 1)) / 2,
    };
    var Ct = en;
    var At = class {
        static {
    ...
    var qi = 8;
    var $i = 4;
    var Qn = [{ name: "a_pos", size: 2 }, { name: "a_uv", size: 2 }, {
        name: "a_color",
        size: 4,
    }];
...
`;
    ...
    var zo = i((n14 = {}) => {
        ...
        let o = n14.canvas ?? (() => {
            ...
            c = n14.scale ?? 1,
            g = n14.width && n14.height && !n14.stretch && !n14.letterbox;
        g
            ? (o.width = n14.width * c, o.height = n14.height * c)
        ...
        let j = I.getContext("2d", { willReadFrequently: true }),
            y2 = Ir({
                canvas: o,
                touchToMouse: n14.touchToMouse,
                gamepads: n14.gamepads,
                pixelDensity: n14.pixelDensity,
                maxFPS: n14.maxFPS,
            }),
            X = [],
            S = y2.canvas.getContext("webgl", {
                antialias: true,
                depth: true,
                stencil: true,
                alpha: true,
            ...
            q = Kn(S, { texFilter: n14.texFilter }),
            E = (() => {
                let t = ht(Xn, Jn),
                    r = Re.fromImage(
                        q,
                    ...
                    s = n14.width && n14.height
                        ? new rt(q, n14.width * P * c, n14.height * P * c)
                        : new rt(
                            q,
                ...
                n14.background
                && (u2 = J(n14.background),
                    a2 = Array.isArray(n14.background)
                        ? n14.background[3]
                        : 1,
                    S.clearColor(u2.r / 255, u2.g / 255, u2.b / 255, a2 ?? 1)),
                    S.enable(S.BLEND),
                    S.blendFuncSeparate(
                        S.SRC_ALPHA,
                ...
                return {
                    ...
                    bgColor: u2,
                    bgAlpha: a2,
                    width: n14.width ?? S.drawingBufferWidth / P / c,
                    height: n14.height ?? S.drawingBufferHeight / P / c,
                    viewport: {
                        x: 0,
                        y: 0,
        ...
        class Q {
            ...
            static fromArrayBuffer(r) {
                return new Promise((s, u2) => te.ctx.decodeAudioData(r, s, u2))
                    .then((s) => new Q(s));
            }
            static fromURL(r) {
                return jn(r)
                    ? Q.fromArrayBuffer(Pr(r))
                    : Vr(r).then((s) => Q.fromArrayBuffer(s));
            }
        }
        let te = (() => {
        ...
        function st(t, r, s = {}) {
            ...
            return document.fonts.add(u2),
                k2.fonts.add(
                    t,
                    u2.load().catch((a2) => {
                        throw new Error(
                            `Failed to load font from "${r}": ${a2}`,
                        );
                    }).then((a2) => new Se(a2, s)),
                );
        }
        ...
        function on(t, r, s, u2, a2 = {}) {
            return k2.bitmapFonts.add(
                t,
                St(r).then((h) =>
                    bn(Re.fromImage(q, h, a2), s, u2, a2.chars ?? zr)
                ),
            );
        }
        i(on, "loadBitmapFont");
        ...
        function Rt(t, r = {}) {
            ...
            t.forEach((b, p) => {
                b instanceof ImageData
                    ? h.putImageData(b, p * u2, 0)
                    : h.drawImage(b, p * u2, 0);
            });
        ...
        function Ye(t, r, s = { sliceX: 1, sliceY: 1, anims: {} }) {
            return r = pe(r),
                Array.isArray(r)
                    ? r.some((u2) => typeof u2 == "string")
                        ? k2.sprites.add(
                            t,
                            Promise.all(r.map((u2) =>
                                typeof u2 == "string"
                                    ? St(u2)
                                    : Promise.resolve(u2)
                            )).then((u2) => Rt(u2, s)),
                        )
                        : k2.sprites.addLoaded(t, Rt(r, s))
                    : typeof r == "string"
                    ? k2.sprites.add(t, K.from(r, s))
                    : k2.sprites.addLoaded(t, K.fromImage(r, s));
        }
        i(Ye, "loadSprite");
        function an(t, r) {
            return r = pe(r),
                k2.sprites.add(
                    t,
                    new Promise(async (s) => {
                        let u2 = typeof r == "string" ? await Et(r) : r,
                            a2 = await Promise.all(u2.frames.map(St)),
                            h = document.createElement("canvas");
                        h.width = u2.width,
                            h.height = u2.height * u2.frames.length;
                        let f = h.getContext("2d");
                        a2.forEach((p, d) => {
                            f.drawImage(p, 0, d * u2.height);
                        });
                        let b = await Ye(null, h, {
                            sliceY: u2.frames.length,
                            anims: u2.anims,
                        });
                        s(b);
                    }),
        ...
        function un(t, r, s) {
            r = pe(r),
                s = pe(s),
                typeof r == "string" && !s && (s = Mr(r) + ".json");
            let u2 = typeof s == "string" ? Et(s) : Promise.resolve(s);
            return k2.sprites.add(
                t,
                u2.then((a2) => {
                    let h = a2.meta.size,
                        f = a2.frames.map((p) =>
        ...
        function hn(t, r, s) {
            r = pe(r), s = pe(s);
            let u2 = i(
                    (h) => h ? Lr(h) : Promise.resolve(null),
                    "resolveUrl",
                ),
                a2 = Promise.all([u2(r), u2(s)]).then(([h, f]) => ht(h, f));
        ...
        function It(t, r = {}) {
            let s = te.ctx,
                ...
                w = false;
            a2.loop = !!r.loop,
                a2.detune.value = r.detune ?? 0,
                a2.playbackRate.value = r.speed ?? 1,
                a2.connect(f),
                a2.onended = () => {
            ...
            let A = i((M) => {
                    a2.buffer = M.buf,
                        u2 || (p = s.currentTime, a2.start(0, b), w = true);
                }, "start"),
                D = mn(t);
            ...
            let N = i(() => {
                    ...
                    let M = u2 ? d - p : s.currentTime - p,
                        O = a2.buffer.duration;
            ...
            return {
                ...
                seek(M) {
                    a2.buffer?.duration && (M > a2.buffer.duration || (u2
                        ? (a2 = _(a2), p = d - M)
                        : (a2.stop(),
                            a2 = _(a2),
                            p = s.currentTime - M,
        ...
        function ht(t = Xn, r = Jn) {
            let s = Wi.replace("{{user}}", t ?? Xn),
                u2 = Xi.replace("{{user}}", r ?? Jn);
            try {
        ...
        function lt(t, r, s, u2 = E.defTex, a2 = E.defShader, h = {}) {
            ...
            let b = E.fixed || s
                    ? E.transform
                    : C.cam.transform.mult(E.transform),
                p = [];
            for (let d of t) {
        ...
        function ft() {
            ...
            E.width = S.drawingBufferWidth / P,
                ...
                We({
                    ...
                    shader: E.postShader,
                    uniform: typeof E.postShaderUniform == "function"
                        ? E.postShaderUniform()
                        : E.postShaderUniform,
                    fixed: true,
                }),
        ...
        function ae() {
            E.transformStack.length > 0
                && (E.transform = E.transformStack.pop());
        }
        i(ae, "popTransform");
        function Be(t) {
            ...
            let r = t.width,
                s = t.height,
                a2 = ut(t.anchor || tn).scale(new v(r, s).scale(-0.5)),
                h = t.quad || new oe(0, 0, 1, 1),
                f = t.color || J(255, 255, 255),
                b = t.opacity ?? 1,
                p = t.tex ? Qr / t.tex.width : 0,
                d = t.tex ? Qr / t.tex.height : 0,
                w = h.x + p,
                A = h.y + d,
                D = h.w - p * 2,
                N = h.h - d * 2;
        ...
        function We(t) {
            ...
            if (t.tiled) {
                let h = Math.ceil((t.width || s) / s),
                    f = Math.ceil((t.height || u2) / u2),
                    p = ut(t.anchor || tn).add(new v(1, 1)).scale(0.5)
                        .scale(h * s, f * u2);
                for (let d = 0; d < h; d++) {
                    for (let w = 0; w < f; w++) {
                        Be(Object.assign({}, t, {
                            pos: (t.pos || new v(0)).add(
                                new v(s * d, u2 * w),
                            ).sub(p),
                            scale: a2.scale(t.scale || new v(1)),
                            tex: t.tex,
                            quad: r,
                            width: s,
                            height: u2,
                ...
                t.width && t.height
                    ? (a2.x = t.width / s, a2.y = t.height / u2)
                    : t.width
                    ? (a2.x = t.width / s, a2.y = a2.x)
                    : t.height && (a2.y = t.height / u2, a2.x = a2.y),
                    Be(Object.assign({}, t, {
                        scale: a2.scale(t.scale || new v(1)),
                        tex: t.tex,
                        quad: r,
        ...
        function ge(t) {
            ...
            let r = t.width,
                s = t.height,
                a2 = ut(t.anchor || tn).add(1, 1).scale(
                    new v(r, s).scale(-0.5),
                ),
        ...
        function l(t) {
            ...
            let u2 = t.width || 1,
                a2 = s.sub(r).unit().normal().scale(u2 * 0.5),
                h = [r.sub(a2), r.add(a2), s.add(a2), s.sub(a2)].map((
                    f,
                ) => ({
                    pos: new v(f.x, f.y),
                    uv: new v(0),
        ...
        function he(t) {
            ...
            let r = t.start ?? 0,
                s = t.end ?? 360,
                u2 = ut(t.anchor ?? "center").scale(
                    new v(-t.radiusX, -t.radiusY),
                ),
                a2 = qe(u2, t.radiusX, t.radiusY, r, s, t.resolution);
            a2.unshift(u2);
            let h = Object.assign({}, t, {
                ...
                ...t.gradient
                    ? {
                        colors: [
                            t.gradient[0],
                            ...Array(a2.length - 1).fill(t.gradient[1]),
                        ],
                    }
                    : {},
            });
            if (s - r >= 360 && t.outline) {
                t.fill !== false && z(Object.assign(h, { outline: null })),
                    z(Object.assign(h, { pts: a2.slice(1), fill: false }));
                return;
            }
            z(h);
        }
                ...
                if (
                    ...
                    let s = t.color ?? W.WHITE,
                        u2 = t.pts.map((h, f) => ({
                            pos: new v(h.x, h.y),
                            uv: new v(0, 0),
                            color: t.colors && t.colors[f]
                                ? t.colors[f].mult(s)
                                : s,
                            opacity: t.opacity ?? 1,
                        })),
                        a2 = [...Array(r - 2).keys()].map((
                            h,
                        ) => [0, h + 1, h + 2]).flat();
                    lt(
                        u2,
        ...
        function Zn(t, r) {
            r.pos && (t.pos = t.pos.add(r.pos)),
                ...
                r.color && t.ch.length === 1
                && (t.color = t.color.mult(r.color)),
            ...
            if (r instanceof Se || typeof r == "string") {
                let Z = r instanceof Se ? r.fontface.family : r,
                    H = r instanceof Se
                        ...
                        : { outline: null, filter: Wn },
                    V = xn[Z]
                        ?? {
                            font: {
                                tex: new Re(q, Yr, Wr, { filter: H.filter }),
                                map: {},
                                size: rn,
                            },
                            cursor: new v(0),
...
`
            ...
            for (let Z of D) {
                ...
                for (let V of Z.chars) {
                    ...
                    if (
                        V.pos = V.pos.add(H, 0).add(
                            fe.w * f.x * 0.5,
                            fe.h * f.y * 0.5,
                        ), t.transform
                    ) {
                        let G = typeof t.transform == "function"
                            ? t.transform(U, V.ch)
                            : t.transform;
                        G && Zn(V, G);
                    }
        ...
        function Je(t) {
            le(),
                ...
                se(t.opt.angle),
                ne(
                    ut(t.opt.anchor ?? "topleft").add(1, 1).scale(
                        t.width,
                        t.height,
                    ).scale(-0.5),
                ),
        ...
        function Un(t = []) {
            let r = /* @__PURE__ */ new Map(),
                ...
                b = {
                    ...
                    use(d) {
                        ...
                        for (let D in d) {
                            ...
                            if (
                                ...
                                throw new Error(
                                    `Duplicate component property: "${D}"`,
                                );
                            }
                        }
                        let A = i(() => {
                    ...
                    get(d, w = {}) {
                        let A = w.recursive
                            ? this.children.flatMap(i(function D(N) {
                                return [N, ...N.children.flatMap(D)];
                            }, "recurse"))
                            : this.children;
                        if (
                            A = A.filter((D) => d ? D.is(d) : true),
                                w.liveUpdate
                        ) {
                            let D = i((_) =>
                                    w.recursive
                                        ? this.isAncestorOf(_)
                                        : _.parent === this, "isChild"),
                                N = [];
                            N.push(En((_) => {
                                D(_) && _.is(d) && A.push(_);
                            })),
        ...
        function Ss(t, r) {
            return {
                ...
                add() {
                    t.exists()
                        && (this.pos = this.follow.obj.pos.add(
                            this.follow.offset,
                        ));
                },
                update() {
        ...
        function Ts(t = {}) {
            ...
            return {
                ...
                update() {
                    this.isOffScreen()
                        ? (s || (this.trigger("exitView"), s = true),
                            t.hide && (this.hidden = true),
                            t.pause && (this.paused = true),
                            t.destroy && this.destroy())
                        : (s && (this.trigger("enterView"), s = false),
                            t.hide && (this.hidden = false),
                            t.pause && (this.paused = false));
                },
            };
        }
        i(Ts, "offscreen");
        ...
        function Os(t = {}) {
            ...
            return {
                ...
                add() {
                    this.area.cursor
                    && this.onHover(() => y2.setCursor(this.area.cursor)),
                        this.onCollideUpdate((u2, a2) => {
                            r[u2.id] || this.trigger("collide", u2, a2),
                                r[u2.id] = a2,
                                s.add(u2.id);
                        });
                },
                update() {
                    for (let u2 in r) {
                        s.has(Number(u2))
                            || (this.trigger("collideEnd", r[u2].target),
                                delete r[u2]);
                    }
                    s.clear();
                },
                ...
                resolveCollision(u2) {
                    ...
                    a2 && !a2.resolved
                        && (this.pos = this.pos.add(a2.displacement),
                            a2.resolved = true);
                },
                localArea() {
                ...
                worldArea() {
                    ...
                    let a2 = this.transform.clone().scale(
                        T(this.area.scale ?? 1),
                    ).translate(this.area.offset);
                    if (u2 instanceof de) {
                        let h = ut(this.anchor || tn).add(1, 1).scale(-0.5)
                            .scale(u2.width, u2.height);
                        a2.translate(h);
                    }
        ...
        function Cn(t, r = {}) {
            ...
            let f = i((b, p, d, w) => {
                let A = T(1, 1);
                return d && w
                    ? (A.x = d / (b.width * p.w), A.y = w / (b.height * p.h))
                    : d
                    ? (A.x = d / (b.width * p.w), A.y = A.x)
                    : w && (A.y = w / (b.height * p.h), A.x = A.y),
                    A;
            }, "calcTexScale");
            return {
                id: "sprite",
                ...
                draw() {
                    ...
                    if (s.slice9) {
                        let { left: p, right: d, top: w, bottom: A } = s.slice9,
                            D = s.tex.width * b.w,
                            N = s.tex.height * b.h,
                            _ = this.width - p - d,
                            M = this.height - w - A,
                    ...
                    u2 && this.stop(),
                        u2 = typeof d == "number"
                            ...
                            : {
                                name: b,
                                timer: 0,
                                loop: p.loop ?? d.loop ?? false,
                                pingpong: p.pingpong ?? d.pingpong ?? false,
                                speed: p.speed ?? d.speed ?? 10,
                                onEnd: p.onEnd ?? (() => {
                                }),
                            },
                        a2 = typeof d == "number"
        ...
        function Rs(t, r = {}) {
            function s(a2) {
                let h = Xe(Object.assign(Qe(a2), {
                    text: a2.text + "",
                    size: a2.textSize,
                    font: a2.font,
                    width: r.width && a2.width,
                    align: a2.align,
                    letterSpacing: a2.letterSpacing,
                    lineSpacing: a2.lineSpacing,
                    transform: a2.textTransform,
                    styles: a2.textStyles,
                }));
                return r.width || (a2.width = h.width / (a2.scale?.x || 1)),
                    a2.height = h.height / (a2.scale?.y || 1),
                    h;
            }
            i(s, "update");
            let u2 = {
            ...
            return {
                ...
                add() {
                    ...
                    this.onCollideUpdate((a2, h) => {
                        if (
                            a2.is("body") && !h.resolved
                            && (this.trigger("beforePhysicsResolve", h),
                                a2.trigger(
                                    "beforePhysicsResolve",
                                    h.reverse(),
                                ),
                                !h.resolved && !(this.isStatic && a2.isStatic))
                        ) {
                            if (!this.isStatic && !a2.isStatic) {
                                let f = this.mass + a2.mass;
                                this.pos = this.pos.add(
                                    h.displacement.scale(a2.mass / f),
                                ),
                                    a2.pos = a2.pos.add(
                                        h.displacement.scale(-this.mass / f),
                                    ),
                                    this.transform = jt(this),
                                    a2.transform = jt(a2);
                            } else {
                                let f = !this.isStatic && a2.isStatic
                                    ? h
                                    : h.reverse();
                                f.source.pos = f.source.pos.add(
                                    f.displacement,
                                ), f.source.transform = jt(f.source);
                            }
                            h.resolved = true,
                                this.trigger("physicsResolve", h),
                                a2.trigger("physicsResolve", h.reverse());
                        }
                    }),
                        this.onPhysicsResolve((a2) => {
                            C.gravity && (a2.isBottom() && this.isFalling()
                                ? (this.vel.y = 0,
                                    r = a2.target,
                                    s = a2.target.pos,
                                    u2
                                        ? u2 = false
                                        : this.trigger("ground", r))
                                : a2.isTop() && this.isJumping()
                                    && (this.vel.y = 0,
                                        this.trigger("headbutt", a2.target)));
                        });
                },
                update() {
                    ...
                    if (
                        ...
                        if (
                            !this.isColliding(r) || !r.exists()
                            || !r.is("body")
                        ) {
                            u2 = true;
                        } else {
                            !r.pos.eq(s) && t.stickToPlatform !== false
                            && this.moveBy(r.pos.sub(s)), s = r.pos;
                            return;
                        }
                    }
                    let a2 = this.vel.y;
                    this.vel.y += C.gravity * this.gravityScale * Me(),
                        this.vel.y = Math.min(this.vel.y, t.maxVelocity ?? Is),
                        a2 < 0 && this.vel.y >= 0 && this.trigger("fall"),
                        this.move(this.vel);
                },
                onPhysicsResolve(a2) {
        ...
        function js(t, r = {}) {
            ...
            return {
                ...
                async add() {
                    await hr(t),
                        s > 0 && this.opacity
                        && await Rn(this.opacity, 0, s, (u2) =>
                            this.opacity = u2, Ct.linear),
                        this.destroy();
                },
            };
        }
            ...
            return {
                ...
                enterState(p, ...d) {
                    ...
                    if (s) {
                        ...
                        if (!A.includes(p)) {
                            throw new Error(
                                `Cannot transition state from "${w}" to "${p}". Available transitions: ${
                                    A.map((D) => `"${D}"`).join(", ")
                                }`,
                            );
                        }
            ...
            C.events.onOnce("frameEnd", () => {
                C.events.trigger("sceneLeave", t),
                    ...
                    [...C.root.children].forEach((s) => {
                        (!s.stay
                            || s.scenesToStay && !s.scenesToStay.includes(t))
                            && C.root.remove(s);
                    }),
                    C.root.clearEvents(),
                    pr(),
        ...
        function cr(t = {}) {
            let r = T(0),
                s = t.isObstacle ?? false,
                u2 = t.cost ?? 0,
                a2 = t.edges ?? [],
                h = i(() => {
                    let b = { left: 1, top: 2, right: 4, bottom: 8 };
                    return a2.map((p) => b[p] || 0).reduce(
                        (p, d) => p | d,
                        0,
                    );
                }, "getEdgeMask"),
            ...
            return {
                ...
                set isObstacle(b) {
                    s !== b
                        && (s = b, this.getLevel().invalidateNavigationMap());
                },
                get isObstacle() {
                    return s;
                },
                set cost(b) {
                    u2 !== b
                        && (u2 = b, this.getLevel().invalidateNavigationMap());
                },
                get cost() {
                    return u2;
                },
        ...
        function Qs(t, r) {
            ...
            let s = gt([qt(r.pos ?? T(0))]),
                ...
                b = null,
                p = null,
                d = i((U) => U.x + U.y * a2, "tile2Hash"),
                w = i(
                    (U) => T(Math.floor(U % a2), Math.floor(U / a2)),
                    "hash2Tile",
                ),
                A = i(() => {
                    h = [];
                ...
                V = i((U, G) => {
                    let B = [],
                        ...
                        ee = U >= a2 && b[U] & 2 && f[U - a2] !== 1 / 0,
                        ue = F < a2 - 1 && b[U] & 4 && f[U + 1] !== 1 / 0,
                        me = U < a2 * u2 - a2 - 1 && b[U] & 8
                            && f[U + a2] !== 1 / 0;
                    return G
                        ? (Y
                            && (ee && B.push(U - a2 - 1),
                    ...
                    getTilePath(U, G, B = {}) {
                        if (
                            f || M(),
                                b || O(),
                                p || ie(),
                                U.x < 0 || U.x >= a2 || U.y < 0 || U.y >= u2
                                || G.x < 0 || G.x >= a2 || G.y < 0 || G.y >= u2
                        ) {
                            return null;
                        }
                        let F = d(U), Y = d(G);
                        ...
                        for (me.set(F, 0); ee.length !== 0;) {
                            ...
                            for (let et of Mn) {
                                let Gn = (me.get(Fe) || 0) + Z(Fe, et)
                                    + H(et, Y);
                                (!me.has(et) || Gn < me.get(et))
                                    && (me.set(et, Gn),
                                        ee.insert({ cost: Gn, node: et }),
                                        ue.set(et, Fe));
                            }
                        }
                        let Dn = [], wt = Y, vi = w(wt);
        ...
        function Zs(t = {}) {
            ...
            return {
                ...
                allowDiagonals: t.allowDiagonals ?? true,
                getDistanceToTarget() {
                ...
                setTarget(h) {
                    r = h,
                        ...
                        s
                            ? (a2
                                || (a2 = this.getLevel().onNavigationMapChanged(
                                    () => {
                                        s && u2 !== null
                                    ...
                                    this.onDestroy(() => a2.cancel())),
                                this.trigger("navigation-started", this),
                                this.trigger("navigation-next", this, s[u2]))
        ...
        i(Zs, "agent");
        function ei(t) {
            let r = y2.canvas.captureStream(t),
        ...
        let gt = C.root.add.bind(C.root),
            ri = C.root.readd.bind(C.root),
            si = C.root.removeAll.bind(C.root),
            On = C.root.get.bind(C.root),
            hr = C.root.wait.bind(C.root),
            ii = C.root.loop.bind(C.root),
            Rn = C.root.tween.bind(C.root);
        function lr(t = 2, r = 1) {
            let s = 0;
            return {
                require: ["scale"],
        ...
        function ui(t, r = {}) {
            ...
            return h.wait(0.4 / u2, () => h.use(lr(u2, a2))),
        ...
        function ci() {
            ...
            function a2(h) {
                if (
                    ...
                    let f = h,
                        p = f.worldArea().bbox(),
                        d = Math.floor(p.pos.x / r),
                        w = Math.floor(p.pos.y / r),
                        A = Math.ceil((p.pos.x + p.width) / r),
                        D = Math.ceil((p.pos.y + p.height) / r),
                        N = /* @__PURE__ */ new Set();
                    for (let _ = d; _ <= A; _++) {
                        for (let M = w; M <= D; M++) {
                            if (!t[_]) {
        ...
        function hi() {
            ...
            t.shake = Ve(t.shake, 0, 5 * Me()),
                t.transform = new Ue().translate(zt()).scale(t.scale).rotate(
                    t.angle,
            ...
            re.paused && Ce(() => {
                ...
                re.showLog && C.logs.length > 0 && Ce(() => {
                    ...
                    for (let u2 of C.logs) {
                        let a2 = "",
                            h = u2.msg instanceof Error ? "error" : "info";
                        a2 += `[time]${u2.time.toFixed(2)}[/time]`,
                            a2 += " ",
                            a2 += `[${h}]${
                                u2.msg?.toString ? u2.msg.toString() : u2.msg
                            }[/${h}]`,
                            r.push(a2);
                    }
                    C.logs = C.logs.filter((u2) =>
                        y2.time() - u2.time < (n14.logTime || $i)
                    );
                    let s = Xe({
                        text: r.join(`
`),
        ...
        function bi() {
            C.events.onOnce("frameEnd", () => {
                y2.quit(),
                    S.clear(
                        S.COLOR_BUFFER_BIT | S.DEPTH_BUFFER_BIT
        ...
        y2.run(() => {
            try {
                k2.loaded
                || $() === 1 && !Kt
                    && (k2.loaded = true, C.events.trigger("load")),
                    !k2.loaded && n14.loadingScreen !== false || Kt
                        ? (dt(), li(), ft())
                        : (re.paused || dr(),
                            ci(),
                            dt(),
        ...
        function pr() {
            y2.onHide(() => {
                ...
                y2.onResize(() => {
                    ...
                    t && !n14.stretch && !n14.letterbox
                        || (o.width = o.offsetWidth * P,
                            o.height = o.offsetHeight * P,
                            mr(),
                            t
                            || (E.frameBuffer.free(),
                ...
                n14.debug !== false
                && (y2.onKeyPress("f1", () => re.inspect = !re.inspect),
                    y2.onKeyPress("f2", () => re.clearLog()),
                    y2.onKeyPress("f8", () => re.paused = !re.paused),
                    y2.onKeyPress("f7", () => {
                    ...
                    y2.onKeyPress("f10", () => re.stepFrame())),
                n14.burp && y2.onKeyPress("b", () => Lt());
        }
        ...
        let Ze = {
            ...
            dt: Me,
            time: y2.time,
            screenshot: y2.screenshot,
            record: ei,
            isFocused: ti,
            setCursor: y2.setCursor,
            getCursor: y2.getCursor,
            setCursorLocked: y2.setCursorLocked,
            isCursorLocked: y2.isCursorLocked,
            setFullscreen: y2.setFullscreen,
            isFullscreen: y2.isFullscreen,
            isTouchscreen: y2.isTouchscreen,
            onLoad: Tn,
            onLoading: fi,
            onResize: mi,
            onGamepadConnect: y2.onGamepadConnect,
            onGamepadDisconnect: y2.onGamepadDisconnect,
            onError: pi,
            onCleanup: wi,
            camPos: rs,
            camScale: ss,
            ...
            onHoverUpdate: ms,
            onHoverEnd: ps,
            onKeyDown: y2.onKeyDown,
            onKeyPress: y2.onKeyPress,
            onKeyPressRepeat: y2.onKeyPressRepeat,
            onKeyRelease: y2.onKeyRelease,
            onMouseDown: y2.onMouseDown,
            onMousePress: y2.onMousePress,
            onMouseRelease: y2.onMouseRelease,
            onMouseMove: y2.onMouseMove,
            onCharInput: y2.onCharInput,
            onTouchStart: y2.onTouchStart,
            onTouchMove: y2.onTouchMove,
            onTouchEnd: y2.onTouchEnd,
            onScroll: y2.onScroll,
            onHide: y2.onHide,
            onShow: y2.onShow,
            onGamepadButtonDown: y2.onGamepadButtonDown,
            onGamepadButtonPress: y2.onGamepadButtonPress,
            onGamepadButtonRelease: y2.onGamepadButtonRelease,
            onGamepadStick: y2.onGamepadStick,
            mousePos: Nt,
            mouseDeltaPos: y2.mouseDeltaPos,
            isKeyDown: y2.isKeyDown,
            isKeyPressed: y2.isKeyPressed,
            isKeyPressedRepeat: y2.isKeyPressedRepeat,
            isKeyReleased: y2.isKeyReleased,
            isMouseDown: y2.isMouseDown,
            isMousePressed: y2.isMousePressed,
            isMouseReleased: y2.isMouseReleased,
            isMouseMoved: y2.isMouseMoved,
            isGamepadButtonPressed: y2.isGamepadButtonPressed,
            isGamepadButtonDown: y2.isGamepadButtonDown,
            isGamepadButtonReleased: y2.isGamepadButtonReleased,
            getGamepadStick: y2.getGamepadStick,
            charInputted: y2.charInputted,
            loop: ii,
            wait: hr,
            play: It,
            volume: gn,
                ...
                fetch(tjaPath).then((response) => {
                    ...
                    try {
                        ...
                        const commands = song.courses[0].singleCourse
                            .getCommands();
                        const chart = commands.toString().replace(
                            "#START,",
                            "",
                        ).replace(",#END", "");
                        const soungCourses = [];
                        song.courses.forEach((course) => {
                            soungCourses.push({
                                ...
                                chart: course.singleCourse.getCommands()
                                    .toString().replace("#START,", "").replace(
                                        ",#END",
                                        "",
                                    ),
                            });
            ...
            "note",
            {
                ...
                addNote() {
                    const subnote = k.add([
                        k.pos(
                            this.pos.add(
                                valuesByRail(rail).dir.scale(this.notesIndex),
                            ),
                        ),
                        k.layer("note"),
                        k.anchor(k.vec2(0, 0.28)),
                    ...
                    subnote.onStateUpdate("destroy", () => {
                        if (rail === 0) {
                            if (
                                notes?.[destroyedIndex]?.pos?.x >= this?.pos?.x
                            ) {
                                removingNote = false;
                            }
                        }
                        if (rail === 1) {
                            if (
                                notes?.[destroyedIndex]?.pos?.y >= this?.pos?.y
                            ) {
                                removingNote = false;
                            }
                        }
    ...
    var loadGameScene = () =>
        k.scene("game", (songData) => {
            ...
            function onHitRail(rail) {
                ...
                const noteDis = hittedNote.worldPos().dist(
                    hitPoint.worldPos(),
                );
                if (noteDis > 30) {
                    if (rail === 0) {
    ...
    var loadSongSelectionScene = () =>
        k.scene("song_selection", () => {
            ...
            k.add([
                ...
                k.anchor("botleft"),
                k.text("AppleBeat 1.1.0 - 12/11/2023 - dev by lajbel", {
                    size: 18,
                }),
            ]);
            k.add([
            ...
            songDatas.forEach((songData, i2) => {
                ...
                songBoxObj.onSelect((songData2) => {
                    demoSong = k.play(songData2.sound, {
                        loop: true,
                        volume: 0.5,
